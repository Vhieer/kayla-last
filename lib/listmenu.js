...
${hituet+=1} ${prefix}pinterest 🅕
${hituet+=1} ${prefix}pinterest2 🅕
${hituet+=1} ${prefix}facebook 🅕
${hituet+=1} ${prefix}soundcloud 🅕
${hituet+=1} ${prefix}instagram 🅕
